...
def createC1(D, minSup):
    ...
    '''
    C1 = []
    # 集合对应的每个序列的所在位置的开始位置，{(1,):{0:2,3:1}}表示前缀(1,)在0序列的结尾为2， 3序列的结尾为1
    postfixDic={}  
    lenD = len(D)
...
if  __name__ =='__main__':
    ...
    data = [
        [1,4,2,3],
        [0, 1, 2, 3],
        [1, 2, 1, 3, 4],[2, 1, 2, 4, 4],[2, 1, 2, 4, 4],[2, 1, 2, 4, 4],[2, 1, 2, 4, 4],[2, 1, 2, 4, 4],
        [2, 1, 2, 4, 4],
        [2, 1, 2, 4, 4],
        [1, 1, 1, 2, 3],
    ]
    ...
    # print(len(readData))
            # break
    L = PrefixSpan(readData, minSup=0.8, minConf=0, sptNum=True)
